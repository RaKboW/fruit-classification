...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default=r"D:\Python\Python Project\fruit-classification\configs\resnet50_ssd512_fruit_feature_fusion.yaml",
        metavar="FILE",
    ...
    parser.add_argument('--eval_step', default=0, type=int, help='Evaluate dataset every eval_step, disabled when eval_step < 0')
